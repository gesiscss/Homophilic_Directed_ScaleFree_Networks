...
def directed_homophilic_barabasi_albert_graph(N, density, minority_fraction, h_MM, h_mm, gamma_M=2.0, gamma_m=2.0, kmin_M=2.0, kmin_m=2.0, kmax_M=None, kmax_m=None, seed=None, verbose=True):
    """
    ...
    - Power-law exponent out-degree distribution of minorities: gamma_m
    - Power-law exponent out-degree distribution of majorities: gamma_M
    """
